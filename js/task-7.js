 ...
 */
console.log(isLoginValid('sfbdfabebetbtn')); // true
console.log(isLoginValid('sfbs')); // true
console.log(isLoginValid('sawgwraerherhrhergrgergergrgerfb')); // false


const isLoginUnique = function(allLogins, login) {
    const invalidLogin = allLogins.includes(login);
    return !invalidLogin;
};
/*
 * Вызовы функции для проверки работоспособности реализации.
 */
console.log(isLoginUnique(logins, 'Kazoomba')); // true
console.log(isLoginUnique(logins, 'Poly')); // false
console.log(isLoginUnique(logins, 'LittleBig')); // true
